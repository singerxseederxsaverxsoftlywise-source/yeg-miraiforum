const TASKS = {
      ...
      groups: [
        {
          ...
          prepItems: [
            { id: "p1", text: "進行台本", done: false },
            { id: "p2", text: "マイク（ハンド）", done: false }
          ]
        },
        {
          id: "g2",
          ...
          prepItems: [
            { id: "p3", text: "配布物（内容は確認）", done: false },
            { id: "p4", text: "役職者・来賓名の紙", done: false },
            { id: "p5", text: "看板", done: false },
            { id: "p6", text: "席次表 / 座席プレート", done: false },
            { id: "p7", text: "音響（機材確認）", done: false },
            { id: "p8", text: "プロジェクター／スクリーン", done: false },
            { id: "p9", text: "配信セット", done: false },
            { id: "p10", text: "撮影機材", done: false },
            { id: "p11", text: "司会台・演台", done: false },
            { id: "p12", text: "マイク（演台用・フロア用）※本数要確認", done: false }
          ]
        },
        {
          id: "g3",
      ...
      groups: [
        {
          ...
          prepItems: [
            { id: "p13", text: "中継用音響・映像機材", done: false },
            { id: "p14", text: "スクリーン", done: false }
          ]
        },
        {
          id: "g7",
  ...
  preTasks: [
    { id: "pre1", text: "4Fホール 予約確定", tanto: "加藤", start: "2026-03-01", end: "2026-03-31", priority: "high", done: false, memo: "" },
    { id: "pre2", text: "プログラム骨子の作成", tanto: "加藤", start: "2026-04-01", end: "2026-04-15", priority: "high", done: false, memo: "" },
    { id: "pre3", text: "登壇者・来賓への依頼", tanto: "加藤", start: "2026-04-01", end: "2026-04-15", priority: "high", done: false, memo: "" },
    { id: "pre4", text: "プレゼン資料 構成確定", tanto: "加藤", start: "2026-04-15", end: "2026-04-20", priority: "high", done: false, memo: "" },
    { id: "pre5", text: "視察先 選定・許可取得", tanto: "加藤", start: "2026-04-15", end: "2026-04-30", priority: "high", done: false, memo: "" },
    { id: "pre6", text: "座席配置プラン作成", tanto: "加藤", start: "2026-05-01", end: "2026-05-10", priority: "high", done: false, memo: "" },
    { id: "pre7", text: "音響・映像 手配", tanto: "加藤", start: "2026-05-10", end: "2026-05-15", priority: "high", done: false, memo: "" },
    { id: "pre8", text: "配布物 準備", tanto: "加藤", start: "2026-05-10", end: "2026-05-28", priority: "mid", done: false, memo: "" },
    { id: "pre9", text: "進行台本 作成", tanto: "加藤", start: "2026-05-20", end: "2026-05-25", priority: "high", done: false, memo: "" },
    { id: "pre10", text: "スタッフレクチャー", tanto: "加藤", start: "2026-06-03", end: "2026-06-03", priority: "high", done: false, memo: "" },
    { id: "pre11", text: "リハーサル", tanto: "加藤", start: "2026-06-05", end: "2026-06-05", priority: "high", done: false, memo: "" }
  ]
};
